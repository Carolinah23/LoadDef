...
filename=("../pmes/output/pme_OceanOnly_M2_cm_convgf_FES2014-M2_stationMesh_PREM.txt")
# %%
#### BEGIN CODE
...
with pygmt.config(MAP_FRAME_TYPE="fancy+",FONT_ANNOT_PRIMARY="16p",FONT="20p"):
    fig.basemap(region=[-95.0, -88.0, 29.0, 33.0], projection="M15c", frame=["ag", '+t"M@-2@- Ocean Tidal Loading"'])

# Plot the coastlines
fig.coast(region=[-95.0, -88.0, 29.0, 33.0], land="white", water="lightgrey", projection="M15c", shorelines=["1/1p","2/0.1p"], borders=["1/0.5p","2/0.5p"])
...
pygmt.makecpt(cmap="seis", series=[0.0,1.0], reverse=True) 
...
refsmmn = 0.5/factor
reflon = 360.0-89.0
refel = [[reflon,32.0,0.0,refsmmj,refsmmn]]
fig.plot(data=refel, style="e", color="white", pen="1p,black")
fig.text(text="1 mm x 0.5 mm", x=reflon, y=32.3, font="16p,Helvetica,black") 
