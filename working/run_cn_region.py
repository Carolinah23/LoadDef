...
#
# This script was edited by C. Hurtado-Pulido
# Program to predict surface displacement caused by surface mass loading by convolving 
# displacement load Green's functions with a model for surface mass load for a region
#
#
...
loadfile_prefix = ("convgf_North_max")
...
meshfname = ("commonMesh_regional_30.3_30.6_-91.28_-90.93_0.001_0.001_oceanmask")
